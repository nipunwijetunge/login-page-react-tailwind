...
const Form = () => {
  ...
  return (
    <form className="subpixel-antialiased shadow-xl w-2/3 bg-white px-10 py-20 rounded-3xl border-2 border-gray-200">
      <h1 className="text-5xl font-extralight">Welcome back</h1>
      <p className="font-light text-lg text-gray-500 mt-4">
      ...
      <div className="mt-8">
        ...
        <div className="mt-3">
          ...
          <input
            className="w-full border-2 border-gray-100 rounded-xl p-4 focus:border-cyan-500 focus:outline-none"
            type="password"
            name="password"
            id="password"
        ...
        <div className="mt-8 flex justify-between items-center">
          ...
          <button className="font-medium text-base text-cyan-500" type="button">
            Forgot password
          </button>
        </div>
